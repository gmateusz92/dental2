"""
Django settings for dental2 project.
...
SECRET_KEY = 'django-insecure-x_qo8&@#p+ydsw(sxodb(fcx0e%pq%1pw+2o1t$9ms@ey!w4cb'
...
WSGI_APPLICATION = 'dental2.wsgi.application'
